 ...
 **/
 ...
 jsPsych.plugins["attention-check"] = (function() {
 	...
 	var questions = [{'Q': '<p>Press the Left Arrow</p>', 'A': 37},
 					 {'Q': '<p>Using your number keypad, select which of the following is <strong>NOT</strong> a car.  <br><br>1) Volvo <br>2) Horse <br>3) Mustang <br>4) Nissan <br>5) Dodge</p>', 'A': 50},
				 	 {'Q': '<p>Press the Right Arrow</p>', 'A': 39},
				 	 {'Q': '<p>Press the Up Arrow</p>', 'A': 38},
				 	 {'Q': '<p>If (10 + 90) / 2 is greater than 50, press the "M" key.  Otherwise press the "Z" key.</p>', 'A': 90},
				 	 {'Q': '<p>Using your number keypad, select which of the following <strong>IS</strong> a car.  <br><br>1) Cat <br>2) Horse <br>3) Person <br>4) Mercedes <br>5) Rat</p>', 'A': 52},
				 	 ...
				 	 {'Q': '<p>If (3 + 12) / 4 is greater than 4 press the "M" key. Otherwise press the "Z" key.</p>', 'A': 90},
